...
public class ConvenioService {
    ...
    public ConvenioDefaultResponseDTO criacao(ConvenioInsertRequestDTO dto) {
        ...
        ConvenioAdministrativo entity = new ConvenioAdministrativo();
    ...
    public ConvenioDefaultResponseDTO updateStatus(Long id, ConvenioAtualizaStatusRequestDTO dto) {
        ...
        try {
            ConvenioAdministrativo entity = repository.getOne(id);
    ...
    public Page<ConvenioDefaultResponseDTO> findAllPaged(Pageable pageable) {
        ...
        Page<ConvenioAdministrativo> list = repository.findAll(pageable);
        logger.info("{} - consulta paginada de recursos realizada com sucesso: {}", logCode, list);
        return list.map(itemConvenioAdministrativoEntity -> new ConvenioDefaultResponseDTO(itemConvenioAdministrativoEntity));
    }
    ...
    public ConvenioDefaultResponseDTO findById(Long id) {
        ...
        Optional<ConvenioAdministrativo> obj = repository.findById(id);
        ConvenioAdministrativo entity = obj.orElseThrow(() -> new ResourceNotFoundException("Recurso nao encontrado id: " + id));

        logger.info("{} - recurso encontrado: {}", logCode, entity);
        return new ConvenioDefaultResponseDTO(entity);
    }

    private void dtoToEntityOnCreate(ConvenioInsertRequestDTO dto, ConvenioAdministrativo entity) {
