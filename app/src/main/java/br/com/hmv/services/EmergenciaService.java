...
import br.com.hmv.dtos.request.emergencia.EmergenciaInsertRequestDTO;
import br.com.hmv.dtos.request.emergencia.EmergenciaUpdateStatusRequestDTO;
import br.com.hmv.dtos.responses.emergencia.DorDefaultResponseDTO;
import br.com.hmv.dtos.responses.emergencia.EmergenciaDefaultResponseDTO;
import br.com.hmv.dtos.responses.emergencia.EmergenciaForListResponseDTO;
import br.com.hmv.dtos.responses.emergencia.EventoTraumaticoEmergenciaDefaultResponsetDTO;
import br.com.hmv.dtos.responses.emergencia.HabitoPacienteEmergenciaDefaultResponsetDTO;
import br.com.hmv.dtos.responses.emergencia.SintomaEmergenciaDefaultResponsetDTO;
...
public class EmergenciaService {
    ...
    @Transactional(readOnly = true)
    public Page<EmergenciaForListResponseDTO> findAllPagedPorPaciente(String idPaciente, Pageable pageable) {
        String logCode = "findAllPagedPorPaciente(String,Pageable)";
        logger.info("{} - consulta paginada de recursos vide parametros {} e idPaciente {}", logCode, pageable, idPaciente);

        Page<Emergencia> list = emergenciaRepository.findEmergenciaByIdPaciente(idPaciente, pageable);
        logger.info("{} - consulta paginada de recursos por paciente realizada com sucesso: {}", logCode, list);
        return list.map(itemEmergenciaEntity -> EmergenciaMapper.INSTANCE.deEntityParaListDto(itemEmergenciaEntity));
    }
