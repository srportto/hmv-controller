...
public class EmergenciaController {
    ...
    public ResponseEntity<Page<EmergenciaForListResponseDTO>> findAllByEmergenciaDoPaciente(@RequestParam String paciente, Pageable pageable) {
        String logCode = "findAllByEmergenciaDoPaciente(String,Pageable)";
        logger.info("{} - solicitacao de consulta todos paginada {} pora todas as emergencias de um paciente {}", logCode, pageable, paciente);

        Page<EmergenciaForListResponseDTO> responseDtoInList = service.findAllPagedPorPaciente(paciente, pageable);
